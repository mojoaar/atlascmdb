...
const ALLOWED_KEYS = new Set([
  ...
  'form_layout_ci',
  'form_layout_ci:server',
  'form_layout_ci:network_device',
  'form_layout_ci:storage',
  'form_layout_ci:database',
  'form_layout_ci:container',
  'form_layout_ci:rack',
  'form_layout_ci:other',
  'form_layout_asset',
  'form_layout_rack',
